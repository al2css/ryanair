...
}, RyanairApp = angular.module("RyanairApp", [ "ngRoute", "ngTouch", "ngSanitize" ]);
...
RyanairApp.config([ "$routeProvider", function($routeProvider) {
    ...
    var mapOptions = {
        ...
        marker.content = '<p class="infoWindowContent">' + info.country.name + "</p>", google.maps.event.addListener(marker, "click", function() {
    ...
    this.title = "Destinations", this.airports = {}, $scope.selected = {}, AirportsFactory.getAirports().then(angular.bind(this, function() {
        this.airports = AirportsFactory.airports;
    })), $scope.openInfoWindow = function(e, selectedMarker) {
        e.preventDefault(), $scope.selected = selectedMarker;
        var mapOptions = {
            zoom: 6,
            minZoom: 5,
            maxZoom: 8,
            ...
            mapTypeId: google.maps.MapTypeId.TERRAIN
        }, map = new google.maps.Map(document.getElementById("map_canvas"), mapOptions), infoWindow = new google.maps.InfoWindow(), marker = new google.maps.Marker({
...
} ]), angular.module("RyanairApp").directive("minimap", [ "AirportsFactory", function(AirportsFactory) {
    "use strict";
    return {
        restrict: "EA",
        replace: !0,
